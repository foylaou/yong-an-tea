import useRootStore from '@/store/useRootStore'; // ✅ 加上這行
...
interface ProductFiveColumnsProps {
    productFiveColumnsContainer?: string;
    products: Product[];
...
export default function ProductFiveColumns({
                                               ...
                                               productFilterPath,
                                               gridTabItems,
                                           }: ProductFiveColumnsProps): JSX.Element {
    ...
    // Tab
    const [tabState, setTabState] = useState<number>(3);
