...
function ProductSixColumns({
    ...
    return (
        <div className="product border-b border-[#ededed] xl:py-[120px] lg:py-[100px] md:py-[80px] py-[50px]">
            <ProductFilterDrawer open={filterOpen} onToggle={() => setFilterOpen(!filterOpen)} productFilter={productFilter} />
            <div className={productSixColumnsContainer}>
                <div className="grid grid-cols-12 lg:gap-x-[25px]">
                    <div className="col-span-12">
                        ...
                        >
                            <div className={`grid xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4 lm:grid-cols-3 sm:grid-cols-2 ${mCol} sm:gap-x-[25px] ${mGap} gap-y-[40px]`}>
                                {currentItems &&
                                    currentItems.map((product: any) => (
                                        <ProductItem
                                            product={product}
